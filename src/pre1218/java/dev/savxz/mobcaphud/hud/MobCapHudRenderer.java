...
public class MobCapHudRenderer {
    ...
    private static void renderRows(DrawContext drawContext, List<HudRow> rows) {
        ...
        drawContext.getMatrices().translate(MobCapHud.CONFIG.hudX, MobCapHud.CONFIG.hudY, 0.0f);
        drawContext.getMatrices().scale(MobCapHud.CONFIG.scale, MobCapHud.CONFIG.scale, 1.0f);
